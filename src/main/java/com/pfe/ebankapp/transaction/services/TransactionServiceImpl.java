...
import com.pfe.ebankapp.account.repo.AccountRepo;
import com.pfe.ebankapp.auth_users.entity.User;
import com.pfe.ebankapp.auth_users.services.UserService;
...
import com.pfe.ebankapp.exceptions.InsufficientBalanceException;
import com.pfe.ebankapp.exceptions.InvalidTransactionException;
...
import com.pfe.ebankapp.transaction.entity.Transaction;
import com.pfe.ebankapp.transaction.repo.TransactionRepo;
...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Response<?> createTransaction(TransactionRequest transactionRequest) {
        ...
        switch (transactionRequest.getTransactionType()) {
            case DEPOT -> handleDeposit(transactionRequest, transaction);
            case RETRAIT -> handleWithdrawal(transactionRequest, transaction);
            case TRANSFERT -> handleTransfer(transactionRequest, transaction);
    ...
    private void sendTransactionNotifications(Transaction tnx) {
        ...
        if (tnx.getTransactionType() == TransactionType.DEPOT) {
        ...
        } else if (tnx.getTransactionType() == TransactionType.RETRAIT) {
            ...
            notificationService.sendEmail(notificationEmailToSendOut, user);
        } else if (tnx.getTransactionType() == TransactionType.TRANSFERT) {
